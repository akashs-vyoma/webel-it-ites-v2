...
const FinalReportFilterSection = () => {
                ...
                <div className="p-6 bg-white">
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
                        ...
                        <div className="md:col-span-4 space-y-2">
                            <label className="text-[13px] font-bold text-slate-600 ml-1">Service Name</label>
                            <div className="relative group">
                                ...
                                <ChevronDown size={18} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none group-hover:text-cyan-500 transition-colors" />
                            </div>
                        </div>

                        {/* From Date */}
                        <div className="md:col-span-3 space-y-2">
                            <label className="text-[13px] font-bold text-slate-600 ml-1">From Date</label>
                        ...
                        {/* To Date */}
                        <div className="md:col-span-3 space-y-2">
                            <label className="text-[13px] font-bold text-slate-600 ml-1">To Date</label>
                            <div className="flex h-11 border border-slate-200 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-cyan-100 focus-within:border-cyan-400 transition-all">
                                <div className="bg-[#4338ca] px-3 flex items-center justify-center text-white">
                                    <Calendar size={18} />
                                </div>
...
export default FinalReportFilterSection;