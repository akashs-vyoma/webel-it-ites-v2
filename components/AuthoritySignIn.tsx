          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                ...
                <div className="flex items-stretch border-2 border-slate-200 rounded-xl overflow-hidden focus-within:border-indigo-500 focus-within:ring-4 focus-within:ring-indigo-500/10 transition-all h-12 bg-white">
                  ...
                  <input
                    ...
                    className="flex-1 px-4 text-slate-900 placeholder:text-slate-400 outline-none font-medium tracking-widest"
                  />
                </div>
            ...
            {(isSuperAdmin || otpSent) && (
              <div className="pt-2 animate-in fade-in duration-300">
                ...
                >
                  {isSuperAdmin ? "Secure Login" : "Verify & Sign In"} <LogIn className="w-4 h-4" />
                </button>
              </div>
            )}
          </form>
        ...
        <div className="bg-amber-50 px-8 py-4 border-t border-amber-200">
          <div className="flex gap-2">
            ...
            <p className="text-amber-800 text-sm font-medium leading-relaxed">
              ...
              <span className="underline decoration-2 decoration-amber-400 text-amber-900">
