...
interface MultiPartyDeclarationProps {
  data?: {
...
const MultiPartyDeclaration: React.FC<MultiPartyDeclarationProps> = ({ data, ref }) => {
  return (
    <div className="bg-gray-200 min-h-screen flex justify-center py-10 px-4 print:p-0 print:bg-white">
      ...
      <div ref={ref} className="relative bg-white w-[210mm] min-h-[297mm] shadow-2xl p-[15px] font-serif box-border overflow-hidden print:shadow-none print:w-full">
        ...
        {/* Standard Decorative Borders (Mimicking ::before and ::after) */}
        ...
        <div className="relative w-full h-full border-2 border-dotted border-gray-800 p-1 flex flex-col box-border">
          ...
          <div className="flex-grow border-[3px] border-double border-gray-800 py-10 px-[50px] relative z-20">
            ...
            <div className="relative z-30 text-[11pt] leading-[1.5] text-black">
              ...
              {/* Main Title */}
              <div className="text-center font-bold underline text-[15pt] mb-6 decoration-1 underline-offset-4">
                Declaration Letter
              </div>

              {/* Date */}
              <div className="text-right font-bold text-[11pt] mb-5">
              ...
              <p className="text-justify mb-4">
                ...
                <span className="font-bold">{data?._it_notification_udin}</span>). We shall indemnify and hold the
                state harmless, including all associated costs in case of any misrepresentation.
              </p>
              ...
              {/* Table Section Title */}
              <div className="text-center font-bold underline text-[13pt] mb-4 decoration-1 underline-offset-4 mt-8">
                Applicants Details
              </div>
              ...
              <table className="w-full border-collapse border border-black text-[10.5pt]">
                <thead>
                  <tr className="bg-[#f2f2f2]">
                    ...
                    <th className="border border-black p-2 w-[120px] text-center">GSTN/PAN Number</th>
                  </tr>
                </thead>
                <tbody>
