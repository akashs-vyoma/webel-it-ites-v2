...
const AdminNav= () => {
    ...
    // Shared tailwind classes to maintain consistency
            ...
            <div className="relative px-4 sm:px-6 lg:px-8 py-3">
                <div className="max-w-[1600px] mx-auto flex items-center justify-between gap-4">
                    ...
                    <div className="hidden lg:flex items-center gap-1 xl:gap-2">
                        ...
                        <div className="group relative">
                            ...
                            <div className={dropdownPanel}>
                                ...
                                <div className="group/sub relative px-2">
                                    ...
                                    {/* Nested Sub-dropdown */}
                                    <div className={subDropdownPanel}>
                                        <Link href="#" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-cyan-50 text-slate-600 hover:text-cyan-600 transition-colors font-semibold text-sm">
                        ...
                        <Link href="/payment-history" className={navItemClasses}>
                            <div className={hoverBubble}></div>
